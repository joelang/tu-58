...
;  wr- and rd- are set high (inactive) for later strobe
;  sel- is set low (active)
...
op_write:
	...
	rjmp op_wri1
;
;inc segment and block
;write to CF if it advances to next block
op_wnxt:
	ldi r17,4
	inc BUFSEG	;point to next 
	cp BUFSEG,r17	;last segment?
