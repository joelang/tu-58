...
;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;baud rate divisor for 11.059Mhz crystal
;
;.equ BAUDL	= $47	;9600 baud rate low	
;.equ BAUDH	= $00	;9600 baud rate high	
;.equ BAUDL	= $23	;19200 baud rate low	
;.equ BAUDH	= $00	;19200 baud rate high
.equ BAUDL	= $11	;38.4k baud rate low	
.equ BAUDH	= $00	;38.4k baud rate high
;
;115.2 is not tested. no QBUS serial board
;runs that fast	
;.equ BAUDL	= $03	;115.2k baud rate low	
;.equ BAUDH	= $00	;115.2k baud rate high
;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;port B pins:
;0 CF card reset-
...
rx_in:
	...
	push r16	;save SREG
;
	sbi PORTB,1	;set scope test bit
...
com_rtn:
	...
	out SREG,r16
	pop r16		;recover r16
	cbi PORTB,1	;clear scope test bit
	reti
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;boot handler
;save unit number
